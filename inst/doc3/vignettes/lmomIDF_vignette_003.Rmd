...
##gg <- gg+scale_fill_continuous(palette=colorRampPalette(colz))
...
plet(out1aggr,1:nlyr(out0aggr), tiles=c("Streets", "Esri.WorldImagery", "OpenTopoMap")[2], collapse=FALSE,shared=TRUE,legend="bottomleft",col=colz) %>% addScaleBar() #%>% lines(v, lwd=2, col="blue") 
