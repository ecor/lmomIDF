...
Assuming a reference period from 1980 to 2010, L-moment are computed as follows (@Hosking20219lmom):

```{r ann.max.samlum.1980.2010,fig.width=7, paged.print=FALSE}
...
```{r ann.max.pel.1980.2010,fig.width=7, paged.print=FALSE}
...
```
```{r ann.max.qua.1980.2010,fig.width=7, paged.print=FALSE}
...
## IDF curves (1981-2010)

Lorem ispsum
```{r ann.max.idf,fig.width=7, paged.print=FALSE}

 
## annual.agg.qua ## TO GO ON 
```


## L-moment estimation (1991-2020)

Lorem ispsum
```{r ann.max_todo,fig.width=7, paged.print=FALSE}
