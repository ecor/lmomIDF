...
## CHACK L-MOMENT VALIDITY with "lmomco" package
library(lmomco)
...
Tha analysis is performet transforming the *SpatRaster* objects defined within  *terra* R package (@terraRpackage) into the RasterStack ones defined in *raster* R package (@rasterRpackage) in order to make use of *rasterList* package (@RasterListPackage) .
